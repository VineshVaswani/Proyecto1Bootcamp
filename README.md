Este proyecto es acerca de un algoritmo que simula el calculo del costo final de la compra de un producto aplicando descuentos, impuestos y costos de envío.
